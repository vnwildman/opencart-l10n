...
$_['text_availability'] = 'Hiện có';
$_['text_instock']      = 'Còn hàng';
$_['text_rating']       = 'Đánh giá';
$_['text_reviews']      = 'Dựa vào %s đánh giá.';
$_['text_summary']      = 'Sơ lược';
$_['text_weight']       = 'Trọng lượng';
$_['text_dimension']    = 'Kích thước (L x W x H)';
$_['text_remove']       = 'Xóa';
$_['text_compare']      = 'So sánh sản phẩm (%s)';
$_['text_success']      = 'Bạn đã thêm sản phẩm <a href="%s">%s</a> vào danh sách <a href="%s">so sánh</a>!';
$_['text_empty']        = 'Chưa có sản phẩm nào để so sánh.';
?>