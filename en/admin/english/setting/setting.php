...
$_['entry_mail_parameter']     = 'Mail Parameters:<span class="help">When using \'Mail\', additional mail parameters can be added here (e.g. "-second@opencart.vn".';
...
$_['error_url']                = 'B?n chua nh?p du?ng d?n c?a c?a hang!';
?>